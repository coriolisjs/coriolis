...
describe("isValidEvent", () => {
  ...
  it(
    `Given an valid event with payload
      When isValidEvent is called with this event
      Then we get true
  `,
    () => {
  ...
  it(
    `Given an valid event with meta
      When isValidEvent is called with this event
      Then we get true
  `,
    () => {
  ...
  it(
    `Given an valid error event with payload and meta
      When isValidEvent is called with this event
      Then we get true
  `,
    () => {
  ...
  it(
    `Given an event with invalid property
      When isValidEvent is called with this event
      Then we get false
  `,
    () => {
  ...
  it(
    `Given an event with invalid meta
      When isValidEvent is called with this event
      Then we get false
  `,
    () => {
